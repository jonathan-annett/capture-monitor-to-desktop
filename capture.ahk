...
CaptureDisplay(displayNum) {
    Run Format("powershell.exe -NoExit -ExecutionPolicy bypass -File capture.ps1 -display {1}",displayNum), ,"Hide"  
}

RandomDownload() {
    Download "https://picsum.photos/1920/1080?random",".\downloaded.jpg"
    Run '.\WallpaperChanger.exe .\downloaded.jpg', ,"Hide"    
}

SetWallpaperFile(filename) {
    Run Format('.\WallpaperChanger.exe {1}',filename), ,"Hide"  
}
